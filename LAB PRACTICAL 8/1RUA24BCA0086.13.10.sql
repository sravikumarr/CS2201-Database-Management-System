...
root@localhost	Sumuks-MacBook.local	8.4.6	2025-10-13 11:36:10
*/
-- Scenario: Employee Management System
-- CREATE AND LOAD THE database DBLab008
create database if not exists dblab008;
use dblab008;
...
(101, 'Anil Kumar', 34, 75000.00, 'manager', '123 MG Road, Bangalore', '2016-05-10'),
(102, 'Sunita Sharma', 28, 50000.00, 'developer', '456 JP Nagar, Bangalore', '2018-07-22'),
(103, 'Rajesh Gupta', 45, 90000.00, 'manager', '789 Koramangala, Bangalore', '2012-03-15'),
(104, 'Priya Singh', 22, 25000.00, 'intern', '321 Indiranagar, Bangalore', '2023-01-30'),
(105, 'Amit Verma', 30, 60000.00, 'team lead', '654 HSR Layout, Bangalore', '2017-11-01'),
(106, 'Deepa Reddy', 41, 45000.00, 'hr', '987 Jayanagar, Bangalore', '2014-02-18'),
(107, 'Sanjay Patel', 25, 12000.00, 'clerk', '159 Marathahalli, Bangalore', '2022-08-09'),
(108, 'Meena Kumari', 38, 80000.00, 'analyst', '753 Whitefield, Bangalore', '2015-06-12'),
(109, 'Vikram Rathod', 29, 55000.00, 'developer', '852 Electronic City, Bangalore', '2019-09-05'),
(110, 'Pooja Desai', 23, 28000.00, 'intern', '456 Bannerghatta Road, Bangalore', '2023-02-11');
